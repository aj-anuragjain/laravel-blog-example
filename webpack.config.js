/**
 * Created by jainhub on 20/03/17.
 */
...
let entry_js = absolutepath("/resources/assets/public/js/core.js");


let entry_sass = absolutepath("/resources/assets/public/js/style.js");


let js_watcher = [
    absolutepath("/resources/assets/public/js/")
];
...
let sass_watcher = [
    absolutepath("/resources/assets/public/scss")
];


let output_path = absolutepath("/public/assets/");
...
if (process.env.NODE_ENV === 'production') {
    config.plugins.push(
        new webpack.optimize.UglifyJsPlugin({
            ...
            extractComments: process.env.NODE_ENV !== 'production'
        })
    )
}
else {
